...
class Obra(models.Model):
    ...
    localidad_barrio = models.CharField("Localidad / Barrio", max_length=200, null=True, blank=True, default="No especificado")
    ...
    mail_telefono_jefe_obra = models.CharField("Mail y Teléfono Jefe de Obra", max_length=200, null=True, blank=True, default="No especificado")
    nombre_capataz = models.CharField("Nombre Capataz", max_length=200, null=True, blank=True, default="No especificado")
    mail_telefono_capataz = models.CharField("Mail y Teléfono Capataz", max_length=200, null=True, blank=True, default="No especificado")
    ...
    mail_telefono_encargado_supervisor = models.CharField("Mail y Teléfono del Encargado de Supervisor Ambiental", max_length=200, null=True, blank=True, default="No especificado")
