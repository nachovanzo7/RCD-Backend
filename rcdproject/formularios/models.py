...
class Formularios(models.Model):
    ...
    # Página 7 (Escombro)
    escombro_limpio = models.CharField("Escombro limpio", max_length=200, choices=[('Aplica','Aplica'), ('no_aplica','No Aplica')], blank=True, null=True, default="no_aplica")
    ...
    # Página 10 (Metales)
    metales = models.CharField("Metales", max_length=200, choices=[('Aplica','Aplica'), ('no_aplica','No Aplica')], blank=True, null=True, default="no_aplica")
    ...
    # Página 11 (Madera)
    madera = models.CharField("Madera", max_length=200, choices=[('Aplica','Aplica'), ('no_aplica','No Aplica')], blank=True, null=True, default="no_aplica")
    ...
    # Página 12 (Mezclados)
    mezclados = models.CharField("Mezclados", max_length=200, choices=[('Aplica','Aplica'), ('no_aplica','No Aplica')], blank=True, null=True, default="no_aplica")
    ...
    puntoAcopio = models.CharField("Punto Acopio", max_length=200, choices=[('Aplica','Aplica'), ('no_aplica','No Aplica')], blank=True, null=True, default="no_aplica")
