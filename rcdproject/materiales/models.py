...
class Material(models.Model):
    ...
    proteccion = models.CharField("Proteccion", max_length=200)
    ...
    ventilacion = models.CharField("Ventilacion", max_length=100, null=True, blank=True, help_text="Obligatorio si el material es 'peligrosos'")
